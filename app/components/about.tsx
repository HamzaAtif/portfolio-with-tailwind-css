import Image from "next/image";  // We use this to show images in our page
import React from "react";        // We import React to build our page

const About = () => {
  return (
    <div id="about">
      {/* This is a section that holds our content */}
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-5 leading-relaxed">
              I am Hamza Atif and learning cutting-edge techs like AI, Web 3.0, and Metaverse from one of the best institutes in Karachi and in the best school of Pakistan, Beaconhouse.
            </p>
          </div>
        </div>
      </section>
